...
These data tell a small part of eviction narratives in the U.S. - who they affect, and why they matter. Informed policymaking is important, and policies must start at the ground: with landlords. Landlords decide who gets to live where, and research has shown that landlord-tenant relationships are [often influenced by tenant race](bit.ly/housing_disc). On a broader scale, the U.S. affordable housing crisis has a synergistic relationship with our eviction crisis, with most low-income families spending over 50 percent of their rent on housing. (About a quarter of the census tracts in our dataset had *average* rent burdens of over 40 percent across 2010-2016.)

In sum, evictions affect individuals, families, and communities across our country, especially those who are otherwise most vulnerable. We need policies that preserve affordable housing and protect victims of long-standing discriminatory housing practices. If you are more interested in learning about current work and research happening around this topic, Eviction Lab's [resources](https://evictionlab.org/) are a great starting point.
