...
We wanted to create an interactive tool to enable readers to understand which predictors affect eviction rate and to what extents. Thus, using the race-based GEE model 
Click here to access this model-building app.

```{r shiny_model}
## this works really well
exp(predict(hyp_model_race, newdata = data.frame(renter_occupied_households = 100,
                                                 years_since_2010 = '4',
                                                 rent_burden = 35,
                                                 density = 50000,
                                           black = 90,
